...
def args_parser():
    ...
    parser.add_argument(
        ...
        type=float,
        default=-1.0,
        help="Target accuracy for stopping training, if not set it will keep training util last round",
    )
    parser.add_argument(
        "--eval_every",
        type=int,
        default=10,
        help="Default eval epochs's gap when setting target_accuracy (default = 10)",
    )
    parser.add_argument(
        "--eval_after",
        type=int,
        default=50,
        help="Do test-set evaluation while training after `eval_after` round",
    )
    ...
    parser.add_argument("--seed", type=int, default=69969, help="random seed")
